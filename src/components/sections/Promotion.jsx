...
export default function Promotion() {
  return (
    <section className=" rounded-lg bg-gradient-to-b from-emerald-200 to-slate-50   lg:p-10 p-5">
        ...
        <div className="mt-5 grid  lg:grid-cols-2 gap-2">
          ...
          <div className=" relative">
            ...
            <div className=" flex flex-col justify-center gap-5">
                ...
                <p className="">Hemat lebih banyak dengan pilihan paket spesial kami.</p>
